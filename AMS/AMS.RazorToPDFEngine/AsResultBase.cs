using AMS.RazorToPDFEngine.Options;
...
namespace AMS.RazorToPDFEngine
{
    public abstract class AsResultBase : ViewResult //IActionResult
    {
        ...
        /// <summary>
        /// Use this if you need another switches that are not currently supported by PdfEngine.
        /// </summary>
        [OptionFlag("")]
        ...
        public async Task<byte[]> BuildFile(ActionContext context)
        {
            ...
            //    this.WkhtmlPath = context.HttpContext.Server.MapPath("~/PdfEngine");

            this.WkhtmlPath = PdfEngineConfiguration.pdfEnginePath;
