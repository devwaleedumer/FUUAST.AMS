...
using Microsoft.EntityFrameworkCore;
    ...
    public static partial class Helpers
    {
        ...
        {
            return !string.IsNullOrWhiteSpace(lle.SortField) ? qry.OrderBy<T>(lle.SortField, lle.SortOrder) : qry;
        }
        ...
        public static IQueryable<T> LazySearch<T>(this IQueryable<T> qry, string? searchTerm,string propName )
        {
          return  string.IsNullOrWhiteSpace(searchTerm) ? qry : qry.Where( x => (EF.Property<T>(x,propName) as string).Contains( searchTerm ));
        }
