...
export class DepartmentService {
  ...
  getAllShiftsByProgramAndDepartmentId(departmentId: number, programId: number): Observable<any> {
    return this._httpService.get<any>(`${this._baseEndPoint}/${departmentId}/${programId}/shifts`)
  }
